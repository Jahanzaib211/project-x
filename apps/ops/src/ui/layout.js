...
export const NAV = [
  ...
  { href: "/orders", label: "Order book", icon: "accounts" },
  { href: "/ledger", label: "Ledger", icon: "database" },
  { href: "/feed", label: "Market feed", icon: "infra" },
  { href: "/telemetry", label: "Telemetry", icon: "logs" },
  { href: "/bridge", label: "MT5 bridge", icon: "modules" },
